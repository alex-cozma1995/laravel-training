        ...
        <div class="card-body">
            <form action="{{ route('stories.update', [$story]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror bg-gray-400" value="{{ old('title', $story->title ) }} "/>
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <textarea name="body" class="form-control @error('body') is-invalid @enderror bg-gray-400">{{ old('body', $story->body ) }}</textarea>
                    @error('body')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }} </strong>
                        </span>
