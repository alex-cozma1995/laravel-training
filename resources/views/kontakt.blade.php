...
<div class="bg-gray-200">
    ...
    @include('fimesznav')
    <!-- endnav -->
    <div class="grid max-w-screen-xl mt-24 grid-cols-1 gap-8 px-8 py-16 mx-auto mt-6 text-gray-900 bg-gray-100 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
        <div class="flex flex-col justify-between">
            <div>
                <h2 class="text-4xl font-bold leading-tight lg:text-5xl">Kapcsolat</h2>
                <p class="mt-1 text-xl text-gray-700 text-semibold">
                    írj nekûnk bátran, várjuk ûzeneted.
                </p>
            </div>
        ...
        <div>
            <div>
                <span class="text-sm font-bold text-gray-600 uppercase">Név</span>
                <input
                    class="w-full p-3 mt-2 text-gray-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text" placeholder="">
            </div>
            <div class="mt-8">
                <span class="text-sm font-bold text-gray-600 uppercase">Email címed</span>
                <input
                    class="w-full p-3 mt-2 text-gray-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text">
            </div>
            <div class="mt-8">
                <span class="text-sm font-bold text-gray-600 uppercase">Uzenet</span>
                <textarea
                    class="w-full h-32 p-3 mt-2 text-gray-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
            </div>
            <div class="mt-8">
                <button
                    class="w-full p-3 text-sm font-bold tracking-wide text-gray-100 uppercase bg-indigo-700 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-br from-green-500 to-blue-600 hover:bg-green-300">
                    Elkûldés
                </button>
            </div>
        </div>
